...
const PostModal: React.FC<PostModalProps> = ({ post, onClose, onDelete, onCommentClick, onShareClick }) => {
    ...
    return (
        <div className="post-modal-backdrop post-modal-backdrop--fullscreen" onClick={onClose} style={{ zIndex: 9999 }}>
